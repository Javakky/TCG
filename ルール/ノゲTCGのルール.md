...
デッキ(50枚)と種のコマ(1枚)を用意します。

デッキを良くカットし、種のコマは裏向きでセットします。

デッキからコマに書かれている枚数、種のコマの下に裏向きにセットします。
...
ブロックが行われなかった場合、対象プレイヤーの種のコマの下にカードがあれば、アタックしたプレイヤーがカードを選んでブレイクします。
...
<!--
フィールドカードのみ1プレイヤーにつき1枚までしか同時に置くことが出来ません。
-->
...
敗北条件を満たしたプレイヤーは、(チェーンに割り込んで)自身のコマの下のカードとこのカードを墓地へ置きます。(強制)

### 種のコマ

種のコマは、条件を満たすことで強力な効果を発動できるカードです。

種のコマ(の下)には、ゲーム開始前にデッキからカードが種のコマに書かれている枚数、裏向きでセットされます。
...
+ メインフェイズ中におけるチェーンの解決後 (ターンプレイヤーへ与えられる)
